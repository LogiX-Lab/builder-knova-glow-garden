export default function Classes() {
  const cards = [
    ...
    },
    {
      ...
      desc: "We provided 4 classes with 9 to 12 children earch aged 12 months to 5 years of age.",
    },
    {
      bg: "#F9B001",
      image:
      ...
      <div className="container">
        <div className="mb-8 flex flex-col gap-6 md:mb-10 md:flex-row md:items-end md:justify-between">
          <div className="md:basis-1/2">
            <h6 className="inline-block rounded-[30px] text-[14px] uppercase text-white">
              Popular Classes
            </h6>
          ...
          <p className="md:basis-1/2 text-white/95">
            Voluptatem per magnam ut assumenda magnis culpa orci, consectetuer,
            eaque, congue. Repudiandae ab ligula ante occaecat habitasse.
            Voluptas hic, aute.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-[1170px] grid-cols-[repeat(auto-fill,minmax(min(288px,100%),1fr))] gap-9">
          {cards.map((c) => (
            <article
              key={c.title}
              className="rounded-[25px] p-4 md:p-4"
            ...
            >
              ...
              <div className="mx-auto -mt-5 flex max-w-[1170px] items-center gap-4 rounded-[30px] bg-white px-7 pb-3 shadow-md">
                <div className="flex items-end gap-2 text-[14px]">
                  <img
                    src="https://creativthemes.com/theme-demo/creativ-preschool-fse/wp-content/themes/creativ-preschool-fse/assets/images/course-img4.png"
                    alt=""
                    className="w-3"
                  />
                  <p className="leading-[14px] md:text-[12px] md:leading-[12px]">
                    {c.lessons}
                  </p>
                </div>
                <div className="flex items-end gap-2 text-[14px]">
                  <img
                    src="https://creativthemes.com/theme-demo/creativ-preschool-fse/wp-content/themes/creativ-preschool-fse/assets/images/course-img5.png"
                    alt=""
                    className="w-4"
                  />
                  <p className="leading-[14px] md:text-[12px] md:leading-[12px]">
              ...
              <div className="mx-auto max-w-[1170px] px-2 pt-7 pb-4 text-white">
                ...
                <p className="mt-4 text-[16px] leading-[25.6px] md:mb-6 md:mt-4">
                  {c.desc}
                </p>
                <a href="#admissions" className="text-[14px] underline">
                  GET STARTED
                </a>
              </div>
            </article>
        ...
        <div className="mx-auto mt-14 flex max-w-[1170px] flex-wrap items-center justify-center gap-4 md:mt-12">
          <a
            href="#admissions"
            className="inline-block rounded-[30px] bg-[#FDA00F] px-7 py-4 text-[14px] font-semibold uppercase text-white hover:brightness-95"
          >
            Enroll Now
          </a>
          <a
            href="#programs"
            className="inline-block rounded-[30px] bg-[#554E9F] px-7 py-4 text-[14px] font-semibold uppercase text-white"
          >
            More Classes
          </a>
        </div>
